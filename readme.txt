...
So I don't have to write, and you don't have to read 10 pages of instructions, the best way to learn to use Lisper and to see what it can do is to check out the lisper help file and lisper-examples.lisp. Definitely do this!!
